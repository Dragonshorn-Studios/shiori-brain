---
name: laravel-php-applications
description: "Use when a task involves Laravel & PHP Applications or needs the corresponding AFFiNE-sourced project workflow and constraints."
---
...
Use this skill when the task touches **Laravel & PHP Applications** or when its project-specific decisions and workflow are relevant.
