---
name: agent-engineering-contract
description: "Use when a task involves Agent Engineering Contract or needs the corresponding AFFiNE-sourced project workflow and constraints."
---
...
Use this skill when the task touches **Agent Engineering Contract** or when its project-specific decisions and workflow are relevant.
