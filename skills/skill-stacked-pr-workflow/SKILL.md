---
name: skill-stacked-pr-workflow
description: "Use when a task involves Skill — Stacked PR Workflow or needs the corresponding AFFiNE-sourced project workflow and constraints."
---
...
Use this skill when the task touches **Skill — Stacked PR Workflow** or when its project-specific decisions and workflow are relevant.
